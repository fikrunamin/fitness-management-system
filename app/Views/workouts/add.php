...
<div class="col-span-full lg:col-span-3 2xl:col-span-2">
    <form action="/workout/add" method="post" enctype="multipart/form-data" class="space-y-5" id="workout_form">
        <div class="grid grid-cols-1 space-y-5 rounded-lg shadow-md bg-white p-5">
            ...
            <div class="col">
                ...
                <div class="flex justify-start items-start space-x-5 space-y-5">
                    ...
                    <img src="" alt="" class="rounded-lg object-cover w-96 h-32 hidden">
                    <div class="">
                        <div>
                            <p class="break-words image-label hidden mb-3" style="max-width: 10rem;"></p>
                        </div>
                        <div>
            ...
            <div class="col">
                ...
                <input type="number" id="iteration" name="iteration" placeholder="5 Times" class="w-full h-10 focus:ring-2 focus:ring-blue-500 px-5 rounded-lg ring-2 ring-blue-200" min="5">
            </div>
            <div class="col">
        ...
        <div class="grid grid-cols-1 space-y-5 rounded-lg shadow-md bg-white p-5 hidden steps">
            ...
            <div class="col">
                ...
                <input type="file" id="image" name="step_image_1" onchange="load_image(this)" class="hidden" accept="image/*">
            </div>
            <div class="col">
            ...
            <div class="col">
                <label class="text-sm font-semibold mb-3 block">Description</label>
                <textarea name="step_description_1" placeholder="Description"></textarea>
            </div>
            <div class="col">
        ...
        <input type="hidden" name="total_steps" value="1">
    </form>
</div>
...
<script>
    ...
    function add_steps(e, index) {
        if (index < 1 || $(e).closest('.grid').next('.steps').length > 0) {
            ...
            <div class="grid grid-cols-1 space-y-5 rounded-lg shadow-md bg-white p-5 hidden steps">
                <div class="col">
                    <h3 class="text-2xl font-bold mb-5">Step ${index + 1}</h3>
                    <hr>
                </div>
                <div class="col">
                    <label class="text-sm font-semibold mb-3 block">Image</label>
                    ...
                    <input type="file" id="image" name="step_image_${index + 1}" onchange="load_image(this)" class="hidden" accept="image/*">
                </div>
                <div class="col">
                    <label class="text-sm font-semibold mb-3 block">Name</label>
